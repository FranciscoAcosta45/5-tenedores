...
export default function InfoUser(props){
    const {
        userInfo : {uid, displayName, email, photoURL},setReloadData, toastRef, setIsLoading, setTextLoading
    } = props;
    ...
    const changeAvatar = async () => {
       ...
       if(resultPermisionCamera === "denied"){
            toastRef.current.show("permisos no aceptados");
       }else {
           ...
           if(result.cancelled){
                toastRef.current.show("operacion cacelada");
             }else{
